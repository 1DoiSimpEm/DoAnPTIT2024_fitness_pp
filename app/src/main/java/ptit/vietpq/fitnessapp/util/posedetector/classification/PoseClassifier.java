...
import static ptit.vietpq.fitnessapp.util.posedetector.classification.PoseEmbedding.getPoseEmbedding;
import static ptit.vietpq.fitnessapp.util.posedetector.classification.Utils.maxAbs;
import static ptit.vietpq.fitnessapp.util.posedetector.classification.Utils.multiply;
import static ptit.vietpq.fitnessapp.util.posedetector.classification.Utils.multiplyAll;
import static ptit.vietpq.fitnessapp.util.posedetector.classification.Utils.subtract;
import static ptit.vietpq.fitnessapp.util.posedetector.classification.Utils.sumAbs;
